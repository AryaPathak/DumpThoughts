...
const HomePage: React.FC<HomePageProps> = ({}) => {
  ...
  return (
    <div className="container mx-auto max-w-2xl p-4">
      <h1 className="text-4xl font-bold text-center mt-10 mb-6 text-white">
        DumpThoughts
      </h1>
      ...
      <form
        ...
        className="bg-[#16181c] p-5 rounded-2xl shadow-lg text-white mt-4"
      >
        <div className="flex space-x-4">
          <img
            src={
              user?.profile_pic_url ||
              "https://demo.patternlab.io/images/fpo_avatar.png"
            }
            alt="Profile"
                  ...
                  <div className="relative">
                    ...
                    <div
                      className={`block w-11 h-6 rounded-full ${
                        isAnonymous ? "bg-blue-600" : "bg-gray-600"
                      }`}
                    />
                    <div
      ...
      <h2 className="text-2xl font-bold text-center mb-3 mt-6 text-white">
        All Posts
      </h2>
      <PostsList
        userId={0}
